...
var afnplk = '```⏱ Time :' + plk_say + '```\n\n ```📅 Date :' + plk_here + '```'
	...
	const buttons = [
      ...
      const buttonMessage = {
          ...
          contentText: ' 𝙷𝚢 𝙱𝚛𝚘....🌝\n\n         ☆ *𝙱𝙾𝚃 𝙸𝙽𝙵𝙾* ☆\n\n⚜️ ɴᴀᴍᴇ  : ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ᴊᴏꜱʜᴜᴠᴀꜱᴇʀ      \n⚜️ sᴛᴀᴛᴇs : ᴘᴜʙʟɪᴄ\n⚜️ ᴛɪᴍᴇ   : ```' + plk_say + '```\n⚜️ ᴅᴀᴛᴇ : ```' + plk_here + '```\n⚜️ ᴘᴇʀғɪx : [ . ]\n\n         ☆ *𝙲𝚁𝙴𝚃𝙴𝚁𝚂* ☆\n\n⚜️𝙹𝚘𝚜𝚑𝚞𝚟𝚊\n\n          ☆ *𝚃𝙷𝙰𝙽𝙺𝚂* ☆\n\n⚜️ ᴄʟɪᴄᴋ ᴍᴇɴᴜ ᴀɴᴅ ᴇɴᴊᴏʏ ᴛʜᴇ ʙᴏᴛ\n',
